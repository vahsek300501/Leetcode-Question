<h2>1611. Minimum One Bit Operations to Make Integers Zero</h2><h3>Hard</h3><hr><div><p>Given an integer <code>n</code>, you must transform it into <code>0</code> using the following operations any number of times:</p>
